...
export default function SuperAdminSettingsPage() {
    ...
    <div className="p-4 sm:p-6 lg:p-8 max-w-4xl">
      <div className="mb-6 sm:mb-8">
        <h1 className="text-xl sm:text-2xl font-bold mb-1">Global Settings</h1>
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-white/40 mt-0.5">
              These settings are currently configured via environment variables.
              Interactive editing will be available in a future update.
            </p>
          </div>
        </div>
      </div>
